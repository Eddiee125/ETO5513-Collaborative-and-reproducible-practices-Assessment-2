...
2:Does one variable moderate on the other? (Maybe the impact of alcohol increases with age.)
...
Age_bands <- cut(cleaned_data$Age, c(seq(9, 70, by = 1), Inf), include.lowest = TRUE)
...
Next is to determine if one variable moderates the effectiveness of the other.

I will use moderation analysis, a variant on the linear regression already performed.
