...
### Section 2: Age-generation and exercise analysis by *Savaira Manoa*
...
fig1_age + geom_line(aes(linetype = percentile, group = percentile)) +
            labs( title. = "Figure 2.1: Percentile of sleep efficiency by age generation",
                          x = "Generation",
                          y = "Sleep Efficiency (%)") +
